...
Europe PMC literature discovery and a hypothesis review loop are implemented;
see RESEARCH.md. Optional OpenAI evidence triage is implemented with mocked tests.
...
Review collected source excerpts, configure private persistence and replacement
