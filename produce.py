...
def request_body(case, plan, format_name, model, max_tool_calls=6):
    ...
    brief = {
        ...
        'assignment': (
            ...
            'Then draft the requested media text for an original talking host. Every factual statement in a segment must '
            ...
            'treatments. Each production_note should name a visual cue and whether the '
            'upper-left evidence window shows an authentic source or an illustration. '
            'The host and evidence assets are produced separately. If evidence is thin, '
            'say so in limits and next_test. Return only '
